#!/usr/bin/env python3
"""Clean Helsinki City Bikes trip data for downstream network analysis."""
...
DEFAULT_COORDS = PROJECT_ROOT / "data" / "reference" / "geocode_cache.csv"
DEFAULT_OUTPUT = PROJECT_ROOT / "data" / "processed" / "2021-04_cleaned.csv"
